      ...
      <div>
        <div className="relative block px-6 py-10 md:py-20 md:px-10">
          ...
          <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-md border border-neutral-500  p-8 text-center shadow">
              <div
              ...
              <h3 className="mt-6 text-gray-200">Customizable</h3>
            ...
            <div className="rounded-md border border-neutral-500  p-8 text-center shadow">
              ...
              <h3 className="mt-6 text-gray-200">Fast Performance</h3>
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
            ...
            <div className="rounded-md border border-neutral-500  p-8 text-center shadow">
              ...
              <h3 className="mt-6 text-gray-200">Fully Featured</h3>
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
